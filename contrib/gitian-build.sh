...
VERSION=
commit=false
url=http://zixinys.com
proc=2
mem=2000
lxc=true
osslTarUrl=http://downloads.sourceforge.net/project/osslsigncode/osslsigncode/osslsigncode-1.7.1.tar.gz
osslPatchUrl=http://zixinys.com/cfields/osslsigncode-Backports-to-1.7.1.patch
...
-u|--url	Specify the URL of the repository. Default is http://zixinys.com
