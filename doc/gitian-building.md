...
*Setup instructions for a Gitian build of GFC coin bt using a Debian VM or physical system.*
...
- [Building GFC coin bt](#building-bitcoin-core)
...
To build GFC coin bt (for Linux, OS X and Windows) just follow the steps under 'perform
