GFC coin bt version 0.14.0 is now available from:
...
To receive security and update notifications, please subscribe to:
  ...
  <http://zixinys.com/en/list/announcements/join/>

Compatibility
==============

GFC coin bt is extensively tested on multiple operating systems using
...
GFC coin bt should also work on most other Unix-like systems but is not
...
GFC coin bt has supported automatically pruning the blockchain since 0.11. Pruning
...
now ZMQ can be used on Windows. Please see [this document](http://zixinys.com/blob/master/doc/zmq.md) for
...
When GFC coin bt is out-of-sync on startup, a semi-transparent information
...
The Alert System was [disabled and deprecated](https://bitcoin.org/en/alert/2016-11-01-alert-retirement) in GFC coin bt 0.12.1 and removed in 0.13.0. 
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of GFC coin bt. This was added in conjunction with
   optimizations to memory management. See [Pull #8753](http://zixinys.com/pull/8753)
