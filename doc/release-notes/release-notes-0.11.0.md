GFC coin bt version 0.11.0 is now available from:
...
defaults to 0.00001. This will cause transactions with fewer GFC/kB fee to be
...
Block pruning allows GFC coin bt to delete the raw block and undo data once 
...
block index and UTXO databases. The minimum was chosen so that GFC coin bt will 
