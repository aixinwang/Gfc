GFC coin bt version 0.9.0 is now available from:
...
Rebranding to GFC coin bt
---------------------------

To reduce confusion between Bitcoin-the-network and Bitcoin-the-software we
have renamed the reference client to GFC coin bt.
...
0.1mACB per kilobyte. During periods of heavy transaction volume, even this
...
- Drop the fee required to relay a transaction to 0.01mACB per kilobyte
