GFC coin bt version 0.9.4 is now available from:
...
GFC coin bt released binaries from https://bitcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoin/+archive/ubuntu/bitcoin
- A third-party or self-compiled GFC coin bt

upgrade to GFC coin bt 0.9.4, which includes a workaround, **before** updating
OpenSSL.
