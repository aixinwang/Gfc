GFC coin bt version 0.13.0 is now available from:
...
In addition to that, with 0.12.x there have been varied reports of GFC coin bt
randomly crashing on Windows XP. It is [not clear](http://zixinys.com/issues/7681#issuecomment-217439891)
...
Various code modernizations have been done. The GFC coin bt code base has
...
HD wallets are incompatible with older versions of GFC coin bt.

[Pull request](http://zixinys.com/pull/8035/files), [BIP 32](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki)
...
proposed parameters, a future release of GFC coin bt is expected that
...
- Each ZMQ notification now contains an up-counting sequence number that allows
  ...
  PR [#7762](http://zixinys.com/pull/7762).
...
- #8153 `75ec320` `fundrawtransaction` feeRate: Use GFC/kB (MarcoFalke)
