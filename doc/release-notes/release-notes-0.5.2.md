...
Use the correct base transaction fee of 0.0005 GFC for accepting transactions into mined blocks (since 0.4.0, it was incorrectly accepting 0.0001 GFC which was only meant to be relayed).
