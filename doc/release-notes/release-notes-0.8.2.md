...
The default fee for low-priority transactions is lowered from 0.0005 GFC 
(for each 1,000 bytes in the transaction; an average transaction is
about 500 bytes) to 0.0001 GFC.

Payments (transaction outputs) of 0.543 times the minimum relay fee
(0.00005430 GFC) are now considered 'non-standard', because storing them
